...
(function () {
  const TEMPLATES = [
    ...
    },
    {
      id: 'outline',
      name: 'Outline',
      desc: 'ขอบหนา ทนทุกฉาก',
      previewHTML: '<div class="preview preview--outline">ทน</div>',
    },
    {
      id: 'neon',
      name: 'Neon',
      desc: 'นีออนเรืองแสง',
      previewHTML: '<div class="preview preview--neon">นีออน</div>',
    },
    {
      id: 'blue_glow',
      name: 'Blue Glow',
      desc: 'ฟ้าเรืองแสง',
      previewHTML: '<div class="preview preview--blue_glow">ฟ้า</div>',
    },
    {
      id: 'sticker',
      name: 'Sticker',
      desc: 'สติ๊กเกอร์ชมพู',
      previewHTML: '<div class="preview preview--sticker">ติ๊ก</div>',
    },
    {
      id: 'green_pop',
      name: 'Green Pop',
      desc: 'เขียวเกมมิ่ง',
      previewHTML: '<div class="preview preview--green_pop">เกม</div>',
    },
    {
      id: 'red_alert',
      name: 'Red Alert',
      desc: 'แดงเร่งด่วน',
      previewHTML: '<div class="preview preview--red_alert">!</div>',
    },
    {
      id: 'purple_punch',
      name: 'Purple Punch',
      desc: 'ม่วงครีเอเตอร์',
      previewHTML: '<div class="preview preview--purple_punch">ม่วง</div>',
    },
    {
      id: 'cyan_ice',
      name: 'Cyan Ice ❄️',
      desc: 'ฟ้าเย็นตา (แนะนำ)',
      previewHTML: '<div class="preview preview--cyan_ice">❄️</div>',
    },
    {
      id: 'orange_sale',
      name: 'Orange Sale',
      desc: 'ส้มโปรโปรโมชั่น',
      previewHTML: '<div class="preview preview--orange_sale">%</div>',
    },
    {
      id: 'white_shadow',
      name: 'White Shadow',
      desc: 'ขาวมินิมอล',
      previewHTML: '<div class="preview preview--white_shadow">ขาว</div>',
    },
    {
      id: 'black_label',
      name: 'Black Label',
      desc: 'ป้ายดำคอนทราสต์สูง',
      previewHTML: '<div class="preview preview--black_label">L</div>',
    },
    {
      id: 'retro_pixel',
      name: 'Retro Pixel',
      desc: 'พิกเซลย้อนยุค',
      previewHTML: '<div class="preview preview--retro_pixel">8-BIT</div>',
    },
    {
      id: 'soft_pastel',
      name: 'Soft Pastel',
      desc: 'พาสเทลนุ่ม',
      previewHTML: '<div class="preview preview--soft_pastel">~</div>',
    },
    {
      id: 'lime_pop',
      name: 'Lime Pop',
      desc: 'เขียวไลม์สดใส',
      previewHTML: '<div class="preview preview--lime_pop">GO</div>',
    },
    {
      id: 'news_ticker',
      name: '📰 News Ticker',
      desc: 'ขาวล่างจอ แบบข่าวทีวี',
      previewHTML: '<div class="preview preview--news_ticker">📰</div>',
    },
    {
      id: 'bold_thunder',
      name: '⚡ Bold Thunder',
      desc: 'ตัวยักษ์ 150pt ดึงสายตา',
      previewHTML: '<div class="preview preview--bold_thunder">⚡</div>',
    },
    {
      id: 'sticker_pop',
      name: '🎯 Sticker Pop',
      desc: 'สติ๊กเกอร์การ์ตูน ขอบหนา 8px',
      previewHTML: '<div class="preview preview--sticker_pop">🎯</div>',
    },
    {
      id: 'instagram',
      name: '📸 Instagram',
      desc: 'ม่วง→ชมพู สไตล์ IG 78pt',
      previewHTML: '<div class="preview preview--instagram">📸</div>',
    },
    {
      id: 'subtitle_heavy',
      name: '🎬 Subtitle Heavy',
      desc: 'ขาว เงาหนา 5 + spacing 3',
      previewHTML: '<div class="preview preview--subtitle_heavy">🎬</div>',
    },
  ];
